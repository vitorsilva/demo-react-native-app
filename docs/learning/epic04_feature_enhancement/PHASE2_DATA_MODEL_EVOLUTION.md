...
| 13 | Write Playwright E2E tests for meal logging | ~2 hours | Test logging flow with prep selection |
| 14 | Write Maestro tests for meal logging | ~2 hours | Mirror Playwright tests for mobile |
| 15 | Update history/display to use components | ~2 hours | UI updates |
| 16 | Write Playwright E2E test for history | ~1 hour | Test named meals show correctly |
| 17 | Write Maestro test for history | ~1 hour | Mirror Playwright test for mobile |
| 18 | Add prep method management UI | ~2 hours | Settings screen |
| 19 | Write Playwright E2E test for prep management | ~1 hour | Test add/delete custom prep methods |
| 20 | Write Maestro test for prep management | ~1 hour | Mirror Playwright test for mobile |
| 21 | Run full test suites | ~20 min | Unit + Playwright + Maestro, verify no regressions |

**Total Estimated Effort:** ~28 hours (including unit + Playwright + Maestro tests)
